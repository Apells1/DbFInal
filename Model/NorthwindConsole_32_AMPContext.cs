...
{
    public partial class NorthwindConsole_32_AMPContext : DbContext
    {
        public NorthwindConsole_32_AMPContext()
        {
        }

        public NorthwindConsole_32_AMPContext(DbContextOptions<NorthwindConsole_32_AMPContext> options)
            : base(options)
        {
        }
